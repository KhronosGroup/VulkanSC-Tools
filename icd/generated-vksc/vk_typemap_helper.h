...
template <>
struct LvlTypeMap<VkPhysicalDeviceVulkanSC10Features> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_SC_1_0_FEATURES> {
...
template <>
struct LvlTypeMap<VkDeviceObjectReservationCreateInfo> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_DEVICE_OBJECT_RESERVATION_CREATE_INFO;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DEVICE_OBJECT_RESERVATION_CREATE_INFO> {
...
template <>
struct LvlTypeMap<VkCommandPoolMemoryReservationCreateInfo> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_COMMAND_POOL_MEMORY_RESERVATION_CREATE_INFO;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_COMMAND_POOL_MEMORY_RESERVATION_CREATE_INFO> {
...
template <>
struct LvlTypeMap<VkPipelineOfflineCreateInfo> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PIPELINE_OFFLINE_CREATE_INFO> {
...
template <>
struct LvlTypeMap<VkPerformanceQueryReservationInfoKHR> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_RESERVATION_INFO_KHR> {
...
template <>
struct LvlTypeMap<VkRefreshObjectListKHR> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_REFRESH_OBJECT_LIST_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_REFRESH_OBJECT_LIST_KHR> {
...
template <>
struct LvlTypeMap<VkExportFenceSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_EXPORT_FENCE_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_EXPORT_FENCE_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkImportFenceSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_IMPORT_FENCE_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_IMPORT_FENCE_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkFenceGetSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_FENCE_GET_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_FENCE_GET_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkSciSyncAttributesInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SCI_SYNC_ATTRIBUTES_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SCI_SYNC_ATTRIBUTES_INFO_NV> {
...
template <>
struct LvlTypeMap<VkExportSemaphoreSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkImportSemaphoreSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkSemaphoreGetSciSyncInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SEMAPHORE_GET_SCI_SYNC_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SEMAPHORE_GET_SCI_SYNC_INFO_NV> {
...
template <>
struct LvlTypeMap<VkPhysicalDeviceExternalSciSyncFeaturesNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_FEATURES_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_FEATURES_NV> {
...
template <>
struct LvlTypeMap<VkExportMemorySciBufInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_EXPORT_MEMORY_SCI_BUF_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_EXPORT_MEMORY_SCI_BUF_INFO_NV> {
...
template <>
struct LvlTypeMap<VkImportMemorySciBufInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_IMPORT_MEMORY_SCI_BUF_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_IMPORT_MEMORY_SCI_BUF_INFO_NV> {
...
template <>
struct LvlTypeMap<VkMemoryGetSciBufInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_MEMORY_GET_SCI_BUF_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_MEMORY_GET_SCI_BUF_INFO_NV> {
...
template <>
struct LvlTypeMap<VkMemorySciBufPropertiesNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_MEMORY_SCI_BUF_PROPERTIES_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_MEMORY_SCI_BUF_PROPERTIES_NV> {
    typedef VkMemorySciBufPropertiesNV Type;
};

#endif  // VK_USE_PLATFORM_SCI
#ifdef VK_USE_PLATFORM_SCI
// Map type VkPhysicalDeviceExternalMemorySciBufFeaturesNV to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCI_BUF_FEATURES_NV
template <>
struct LvlTypeMap<VkPhysicalDeviceExternalMemorySciBufFeaturesNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCI_BUF_FEATURES_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCI_BUF_FEATURES_NV> {
...
template <>
struct LvlTypeMap<VkApplicationParametersEXT> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_APPLICATION_PARAMETERS_EXT;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_APPLICATION_PARAMETERS_EXT> {
...
template <>
struct LvlTypeMap<VkPhysicalDeviceExternalSciSync2FeaturesNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SCI_SYNC_2_FEATURES_NV> {
...
template <>
struct LvlTypeMap<VkSemaphoreSciSyncPoolCreateInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_POOL_CREATE_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_POOL_CREATE_INFO_NV> {
...
template <>
struct LvlTypeMap<VkSemaphoreSciSyncCreateInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_CREATE_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SEMAPHORE_SCI_SYNC_CREATE_INFO_NV> {
    typedef VkSemaphoreSciSyncCreateInfoNV Type;
};

#endif  // VK_USE_PLATFORM_SCI
#ifdef VK_USE_PLATFORM_SCI
// Map type VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV to id
// VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV
template <>
struct LvlTypeMap<VkDeviceSemaphoreSciSyncPoolReservationCreateInfoNV> {
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DEVICE_SEMAPHORE_SCI_SYNC_POOL_RESERVATION_CREATE_INFO_NV> {
