...
static VKAPI_ATTR void VKAPI_CALL GetPhysicalDeviceQueueFamilyProperties(VkPhysicalDevice physicalDevice,
    ...
    if (pQueueFamilyProperties) {
        std::vector<VkQueueFamilyProperties2KHR> props2(*pQueueFamilyPropertyCount, {VK_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2});
...
static VKAPI_ATTR void VKAPI_CALL GetPhysicalDeviceProperties2(VkPhysicalDevice physicalDevice,
    ...
    if (props_12) {
        ...
        props_12->maxPerStageDescriptorUpdateAfterBindSamplers = pProperties->properties.limits.maxPerStageDescriptorSamplers;
        ...
        props_12->maxPerStageUpdateAfterBindResources = pProperties->properties.limits.maxPerStageResources;
        props_12->maxDescriptorSetUpdateAfterBindSamplers = pProperties->properties.limits.maxDescriptorSetSamplers;
        props_12->maxDescriptorSetUpdateAfterBindUniformBuffers = pProperties->properties.limits.maxDescriptorSetUniformBuffers;
        ...
        props_12->maxDescriptorSetUpdateAfterBindStorageBuffers = pProperties->properties.limits.maxDescriptorSetStorageBuffers;
        ...
        props_12->maxDescriptorSetUpdateAfterBindSampledImages = pProperties->properties.limits.maxDescriptorSetSampledImages;
        props_12->maxDescriptorSetUpdateAfterBindStorageImages = pProperties->properties.limits.maxDescriptorSetStorageImages;
        props_12->maxDescriptorSetUpdateAfterBindInputAttachments = pProperties->properties.limits.maxDescriptorSetInputAttachments;
    }
