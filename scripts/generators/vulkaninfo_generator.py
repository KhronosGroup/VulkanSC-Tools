...
class VulkanInfoGenerator(BaseGenerator):
    ...
    def generate(self):
        ...
        for key, ext_info in EXTENSION_CATEGORIES.items():
            ...
            # Skip structures not part of the target API
            if not ext_info.get('extends') in self.vk.structs:
                continue
...
''')
    ...
    def GetStructCheckStringForMatchingExtension(self, struct, structName):
        ...
        # NOTE: We can reach here if the extension in question is not part of the target API
        return "false"
